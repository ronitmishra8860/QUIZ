class Question {
  ...
  display(){
    ...
    this.title.position(350, 0);
     ...
     //this.question("what is the full form of HTML? " );
    // this.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );
    this.question.html("what is the full form of HTML? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: HYPER TEXT MARKUP LANGUAGE " );
    this.option1.position(150, 100);
    this.option2.html("2: HYPER MARKUP LANGUAGE" );
    this.option2.position(150, 120);
    this.option3.html("3: MARKUP LANGUAGE " );
    this.option3.position(150, 140);
    this.option4.html("4: HYPER TEXT" );
